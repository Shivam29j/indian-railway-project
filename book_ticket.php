...
$h=1;
$pnr=$pn+$h;
$query2="INSERT INTO ticket(name,dob,email,adhar,train,doj,gender,pnr) value('$n','$o','$p','$q','$r','$s','$t','$pnr')";
mysql_query($query2);
$query3="UPDATE pnr SET pnrno='$pnr' ";
mysql_query($query3);
...
if($count>0)
{$i=1;
	echo "<table border='2' width='95%'><tr><th>name</th><th>dob</th><th>email</th><th>adhar</th><th>train</th><th>doj</th><th>gender</th><th>pnrno.</th></tr>";
                    ...
                    <div class="box info-bar">
                        <div class="row">
                            <!--<div class="col-sm-12 col-md-4 products-showing">-->
								...
								<h>1.General rules/information for e-ticket passenger have to be studied by the customer for cancellation and refund.</h><br>
								<h>2.Valid IDs to be presented during train journey by one of the passenger booked on e-ticket-voter identity/PAN card.,etc</h><br>
								<h>3.Just dial 139 from your landline, mobile and CDMA phone for railway enquiry. </h><br>
								<h>4.IRCTC customer support@</h><br>
								<h>Delhi:011-23340000/23345500</h><br>
								<h>Email:care@irctc.co.in</h><br>
